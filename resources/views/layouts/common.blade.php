...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed {{ (Auth::user() && Auth::user()->role_id == 1)  ? 'parent-page' : '' }}">
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown profile-dropdown">
                <a class="nav-link" title="profile" data-toggle="dropdown" href="#">
                    <span class="profile-img">
                        <img src="{{ ((Auth::user()->profile_image) && file_exists(public_path('storage/upload/user/'.Auth::user()->profile_image))) ? asset('storage/upload/user/'.Auth::user()->profile_image) : url('img/profile-image.svg') }}" alt="User Image"></span>
                    <h4>{{ Auth::user()->name }}</h4>
                </a>
                <div class="dropdown-menu">
                    <a href="#" title="profile" class="dropdown-item">
                        Profile
                    </a>
                </div>
            </li>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route('home')}}" class="brand-link">
            <img src="{{ asset('img/login-logo.svg') }}" alt="Logo" class="brand-image elevation-3">
        </a>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('home') }}"
                           class="nav-link {{ (request()->is('/') || request()->is('filters') || request()->is('filterCourse')) ? 'active' : '' }}">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="#"
                            class="nav-link {{ (request()->is('parent*')) ? 'active' : '' }}">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-160371119-1"></script>
<script>
    $(function () {
